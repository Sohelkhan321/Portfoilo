...
const Responsive =()=>{
    ...
    return(
       ...
       <div id='about'>
              ...
              <div className="flex flex-col justify-around h-40 items-center mb-12 m-4">
                   <h1 className="text-4xl font-bold">ABOUT ME</h1>
                   <div className="bg-yellow-400 w-16 rounded-full text-center">...</div>
                   <p className="text-2xl text-center">Here you will find more information about me, what I do, and my current skills mostly in terms of programming and technology.</p>
              </div>
             ...
             <div className=" md:flex flex-row">
              ...
              <div className="w-full flex flex-col justify-between items-center ml-4 mt-2 space-y-8 ">
                      <h1 className="text-3xl font-bold m-4">Get to know me!</h1>
                ...
                <div className="flex flex-col justify-center items-start  space-y-4  mt-12">
